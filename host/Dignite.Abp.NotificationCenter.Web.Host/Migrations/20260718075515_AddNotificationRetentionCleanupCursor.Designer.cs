...
namespace Dignite.Abp.NotificationCenter.Web.Host.Migrations
{
    ...
    [Migration("20260718075515_AddNotificationRetentionCleanupCursor")]
    partial class AddNotificationRetentionCleanupCursor
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Dignite.Abp.NotificationCenter.Notification", b =>
                {
                    ...
                    b.Property<DateTime?>("RetentionDeletionTime")
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("TenantId", "RetentionDeletionTime", "CreationTime");
            ...
            modelBuilder.Entity("Dignite.Abp.NotificationCenter.NotificationDeliveryRecord", b =>
                {
                    ...
                    b.HasIndex("State", "CompletedTime");

                    b.HasIndex("State", "LeaseExpirationTime");

                    b.HasIndex("State", "NextAttemptTime");

                    b.HasIndex("TenantKey", "NotificationId");

                    b.HasIndex("TenantKey", "State", "CompletedTime");
            ...
            modelBuilder.Entity("Dignite.Abp.NotificationCenter.UserNotification", b =>
                {
                    ...
                    b.HasIndex("TenantId", "State", "CreationTime");
